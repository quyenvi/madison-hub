...
function bindMath(){
 document.querySelector('#math-level').onchange=event=>{mathLevel=event.target.value;state.mathLevel=mathLevel;save();startQuiz();document.querySelector('#math-description').textContent=content.mathLevels.find(l=>l.id===mathLevel).description;drawQuiz();};
